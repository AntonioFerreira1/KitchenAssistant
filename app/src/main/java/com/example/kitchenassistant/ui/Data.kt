...
enum class Unit(val s: String) {
    GRAMS("g"), KILOGRAM("kg"), UNIT("unit"), PACKAGE("package"), LITERS("l"), MILLILITERS("ml")
}


val allProds = arrayOf(
    Prod("Bread", "bread"),
    Prod("Milk", "milk"),
    Prod("Potatoes", "potatoes"),
    Prod("Butter", "butter"),
    Prod("Chicken breasts", "chicken_breasts"),
    Prod("Rice", "rice")
)
